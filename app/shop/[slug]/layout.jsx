    ...
    <div className=" flex justify-between items-start container mx-auto gap-4">
      ...
      <aside className=" w-80 max-w-80 rounded-md flex flex-col gap-8">
        <div className=" flex flex-col gap-8">
          <button className=" flex justify-center items-center text-center rounded-md p-2 w-full bg-orange-500 transition-all duration-300 hover:bg-orange-600 text-white">
            30,000 تومان - افزودن به سبد خرید
          </button>
          <button className=" flex justify-center items-center text-center rounded-md p-2 w-full bg-blue-500 transition-all duration-300 hover:bg-blue-600 text-white">
