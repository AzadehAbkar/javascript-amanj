        ...
        <div className=" flex justify-start items-center gap-4 w-full ">
          <div>
            <Image
              ...
              height={200}
              alt={"this is alt"}
              src={"/image/blog-images/ADSL-Modem-1.jpg"}
              priority={true}
            />
          </div>
          <div className=" h-[12rem] flex flex-col gap-8">
            <h1 className=" text-lg"> مودم فوق قدرت مند  </h1>
        ...
        <div className=" w-[20rem] rounded-md flex justify-center items-center gap-2 bg-slate-100 p-4 transition-all duration-300 hover:bg-slate-200">
          <div className=" flex justify-start items-center gap-6 w-full">
            <Image
              ...
              height={100}
              alt={"this is alt"}
              src={"/image/icons/target1.png"}
              priority={true}
            />
            <div className=" flex flex-col gap-3">
              <div className=" font-bold text-base sm:text-sm">پشتیبانی</div>
