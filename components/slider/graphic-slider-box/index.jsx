...
const SlideBox = () => {
   return <article className="sliderItem p-2  hover:pt-0 transition-all duration-300 ">
       <div className="relative bg-white h-[27.5rem] w-72 rounded-lg ">
         <Link className=" flex justify-center items-center pt-2" href={"/shop"}>
           <Image width={270} height={150} className=" rounded-md" src={"/image/blog-images/hard-disk-cover.jpg"} alt="alt" />
         </Link>
           ...
           <div className=" flex flex-col gap-6 p-2">
             <Link href={"/shop"}>
               <h3 className=" line-clamp-2">
                 عنوان محصول هستنوان محصول هستنوان محصول هستنوانل هستندوان
             ...
             <div className=" categories flex justify-start items-center flex-wrap gap-1">
               <Link className=" py-1 px-2 rounded bg-zinc-200 transition-all duration-300 hover:bg-zinc-300" href={"/"}>
                 رمان
               </Link>
               <Link className=" py-1 px-2 rounded bg-zinc-200 transition-all duration-300 hover:bg-zinc-300" href={"/"}>
                 داستانی
